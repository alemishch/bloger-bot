...
def _enum_values(enum_cls):
    """Always use .value (lowercase strings) not .name for PostgreSQL enums."""
...
class ContentSource(Base):
    ...
    source_type: Mapped[SourceType] = mapped_column(
        SAEnum(SourceType, values_callable=_enum_values, name="sourcetype"),
        nullable=False
    )
    blogger_id: Mapped[BloggerID] = mapped_column(
        SAEnum(BloggerID, values_callable=_enum_values, name="bloggerid"),
        nullable=False
    )
...
class ContentItem(Base):
    ...
    content_type: Mapped[ContentType] = mapped_column(
        SAEnum(ContentType, values_callable=_enum_values, name="contenttype"),
        nullable=False
    )
    status: Mapped[JobStatus] = mapped_column(
        SAEnum(JobStatus, values_callable=_enum_values, name="jobstatus"),
